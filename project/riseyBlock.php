...
//This the game, did not have time to add all the functions to it to send scores to the scoreboard.
?>
<!DOCTYPE html>
<html>
...
<div id="canvascontainer" style="border: 3px solid black;"></div>
<br>
